    ...
    [...data.replace(/[\r]/g, '').split('\n')].forEach((data, idx) => {
        ...
        switch (lineIndex) {
            ...
            case 4:
                ...
                // What makes or breaks it, I'd be lying if I said I didn't look for hints to solve this.
                modTest *= Number(tester);
                break;
            case 5:
